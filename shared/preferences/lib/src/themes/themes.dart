...
ThemeData _appTheme(Color seedColor, bool isDarkThemeMode) {
  ...
  return baseTheme.copyWith(
    ...
    scaffoldBackgroundColor: isDarkThemeMode
...
class AntinnaAppTheme extends ThemeExtension<AntinnaAppTheme> {
  ...
  AntinnaAppTheme({required this.isDarkThemeMode, required this.seedColor})
  ...
  AntinnaAppTheme lerp(
    covariant ThemeExtension<AntinnaAppTheme> other,
    double t,
  ) {
